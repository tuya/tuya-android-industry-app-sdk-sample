 ...
 */
public class DeviceZigBeeSubAdapter extends RecyclerView.Adapter<DeviceZigBeeSubAdapter.DeviceHolder> {

    private Context mContext;
    private List<SubDeviceBean> mList;

    private OnRecyclerItemClickListener mListener;

    public DeviceZigBeeSubAdapter(Context context) {
        mContext = context;
    }

    @Override
    public DeviceHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_layout_device_zigbee_sub, parent, false);
    ...
    public interface OnRecyclerItemClickListener {
        void onItemClick(View view, SubDeviceBean deviceBean);

        void onItemLongClick(View view, SubDeviceBean deviceBean);
    }
}
